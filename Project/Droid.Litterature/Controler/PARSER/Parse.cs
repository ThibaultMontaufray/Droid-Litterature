...
namespace Droid.Litterature
{
    ...
    public class Parse
    {
        ...
        public static string Traduction(string text, string currentLanguage)
        {
        ...
        private void ProcessWord(Sentense sent, ref Word w)
        {
            ...
            if (Interface_litterature.Dictionnary != null) { Interface_litterature.Dictionnary.ParseSyllabe(w); }
        }
        ...
        private List<Verb> SearchVerbs(Word w)
        {
            ...
            try
            {
                if (Interface_litterature.Dictionnary != null && Interface_litterature.Dictionnary.Conjugaison != null && Interface_litterature.Dictionnary.Conjugaison.Times != null)
                { 
                    ...
                    if (!_flagFind && Interface_litterature.Dictionnary.ListVerbs != null)
                    {
                        foreach (Verb dico_verb in Interface_litterature.Dictionnary.ListVerbs)
                        {
                            ...
                            {
                                Console.WriteLine("Can't find infinitive verb : " + exp.Message + " verb : " + dico_verb.Text);
                            }
                        }
                    }
                }
            ...
            {
                Console.WriteLine("Can't find verb : " + exp.Message);
            }
            return _lv;
        }
        private List<Pronom> SearchPronoms(Word w)
        {
            ...
            if (Interface_litterature.Dictionnary != null && Interface_litterature.Dictionnary.ListPronoms != null)
            { 
        ...
        private List<NomCommun> SearchNomsCommuns(Word w)
        {
            ...
            if (Interface_litterature.Dictionnary != null && Interface_litterature.Dictionnary.ListNomCommuns != null)
            {
        ...
        private List<NomPropre> SearchNomsPropres(Word w)
        {
            ...
            if (Interface_litterature.Dictionnary != null && Interface_litterature.Dictionnary.ListNomPropres != null)
            { 
        ...
        private List<Adjective> SearchAdjectives(Word w)
        {
            ...
            if (Interface_litterature.Dictionnary != null && Interface_litterature.Dictionnary.ListAdjectives != null)
            {
        ...
        private List<Adverb> SearchAdverbs(Word w)
        {
            ...
            if (Interface_litterature.Dictionnary != null && Interface_litterature.Dictionnary.ListAdverbs != null)
            {
        ...
        private List<Conjonction> SearchConjonctions(Word w)
        {
            ...
            if (Interface_litterature.Dictionnary != null && Interface_litterature.Dictionnary.ListConjonctions != null)
            {
        ...
        private List<Determinant> SearchDeterminants(Word w)
        {
            ...
            if (Interface_litterature.Dictionnary != null && Interface_litterature.Dictionnary.ListDeterminant != null)
            {
        ...
        private List<Preposition> SearchPreposition(Word w)
        {
            ...
            if (Interface_litterature.Dictionnary != null && Interface_litterature.Dictionnary.ListPreposition != null)
            {
        ...
        private List<Chiffre> SearchChiffre(Word w)
        {
            ...
            if (Interface_litterature.Dictionnary != null && Interface_litterature.Dictionnary.ListChiffre != null)
            {
        ...
        private void SetVerbDefinition(Word w)
        {
            try
            {
                if (w is Verb && !string.IsNullOrEmpty((w as Verb).Infinitive))
                {
                    ...
                    DataTable dbDetails = DBAdapter.ExecuteReader(Parameters.Config["DB_NAME"].ToString(), string.Format("select définition from {0}.t_mot where valeur = '{1}';", Parameters.Config["DB_SCHEMA"].ToString(), (w as Verb).Infinitive));
